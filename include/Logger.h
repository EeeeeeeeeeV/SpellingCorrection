...
#define MY_LOG_WARN( msg ) \
	do { \
			Logger::get_instance().warn( msg );\
	}while(0)

#define MY_LOG_NOTICE( msg ) \
	do { \
			Logger::get_instance().notice( msg );\
	}while(0)
...
/*	class Garbage
	{
		public:	
			~Garbage()
			{
				printf("Logger deconstruction\n");
				log4cpp::NDC::clear();
				log4cpp::Category::shutdown();
				printf("Logger deconstruction complete\n");
			}
